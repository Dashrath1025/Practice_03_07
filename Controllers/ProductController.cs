...
namespace Practice_03_07.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            IEnumerable<Product> objList = _db.Products.Include(u => u.SubCategory);
            return View(objList);
        }
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            {
                Product = new Product(),
                SubCategorySelectList = _db.subCategories.Select(e => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem
                {
                    Text = e.Name,
                    Value = e.Id.ToString()
                })
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            ...
            productVM.SubCategorySelectList = _db.subCategories.Select(i => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem
            {
                Text = i.Name,
                Value = i.Id.ToString()
            });
        ...
        public IActionResult Delete(int? id)
        {
            ...
            Product product = _db.Products.Include(e => e.SubCategory).FirstOrDefault(u => u.Id == id);
